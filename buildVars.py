...
addon_info = AddonInfo(
	...
	addon_description=_("An accessibility-centric, OS-level, high-performance macro recording, editing, and playback engine (IDE)."),
	addon_version="1.1.0",
	addon_changelog=_("Major IDE update including native clipboard, smart keys, dynamic event injection, and i18n support."),
	addon_author="Muhammet Enes Şenovalı <mesenovali@gmail.com>",
